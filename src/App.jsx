...
function App() {
    ...
    return (
        <div className="w-full h-screen bg-brand-dark relative overflow-hidden">
            ...
            <div className={`w-full h-full transition-all duration-700 ${selectedLayerIndex !== null ? 'opacity-30 scale-95 blur-sm' : ''}`}>
                <Canvas camera={{ position: [6, 4, 6], fov: 40 }}>
                    <Suspense fallback={null}>
                        ...
                        <EnergyStack onLayerSelect={setSelectedLayerIndex} hoveredLayer={hoveredLayer} onLayerHover={setHoveredLayer} />
            ...
            <div className={`absolute top-0 left-0 w-full p-12 md:p-16 z-10 pointer-events-none transition-opacity duration-500 ${selectedLayerIndex !== null ? 'opacity-0' : 'opacity-100'}`}>
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-500 mb-4 uppercase">
                    THE AI ENERGY STACK
                </h1>
                <p className="text-gray-400 text-lg md:text-2xl max-w-2xl leading-relaxed font-light">
                ...
                <div className="mt-8 max-w-lg">
                    ...
                    <p className="text-brand-blue font-medium text-xs uppercase tracking-widest animate-pulse">
                        Click any layer to explore
                    </p>
                </div>
            </div>

            {/* Fixed Labels Overlay - Pure DOM, no 3D */}
            <div className={`absolute right-[32%] top-1/2 z-10 pointer-events-none transition-opacity duration-500 ${selectedLayerIndex !== null ? 'opacity-0' : 'opacity-100'}`}>
                ...
                {activeLayer && (
                    <div className="absolute inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        <motion.div
                            ...
                            className="relative w-full max-w-5xl h-[80vh] bg-black/80 border border-gray-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row"
                        ...
                        >
                            ...
                            <div className="w-full md:w-1/3 bg-gray-900/50 p-8 border-r border-gray-800 flex flex-col justify-between relative overflow-hidden">
                                ...
                                <div>
                                    ...
                                    <h2 className="text-4xl font-bold tracking-tight mb-4 text-white">{activeLayer.title}</h2>
                                    <h3 className="text-xl text-white font-light">{activeLayer.subtitle}</h3>
                                </div>

                                <div className="mt-12">
                                    <div className="text-4xl font-mono text-white font-bold mb-1">{activeLayer.stat}</div>
                                    <div className="text-xs text-gray-500 font-mono uppercase tracking-wider">Estimated Scale</div>
                                </div>
                            </div>
